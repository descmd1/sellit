    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">Join SellIt and start buying or selling</p>
        </div>
        ...
        <div className="card p-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                {(['buyer', 'seller'] as const).map((r) => (
                  <label key={r} className={`relative cursor-pointer`}>
                    ...
                    <div className={`border-2 rounded-lg p-3 text-center transition ${role === r ? 'border-primary-500 bg-primary-50' : 'border-gray-200 hover:border-gray-300'}`}>
            ...
            {role === 'seller' && (
              <div>
                <label className="label">Address <span className="text-gray-400 font-normal">– Helps admin find you</span></label>
                <input {...register('address')} className="input" placeholder="e.g., 12 Allen Ave, Ikeja, Lagos" />
              </div>
            )}
            ...
            <div>
              ...
              <div className="relative">
                <input {...register('password')} type={showPass ? 'text' : 'password'} className="input pr-10" placeholder="Min. 6 characters" />
